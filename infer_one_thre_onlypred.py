...
from dataset.dataload import (
    func_getdataloader,
    func_getdataloader_16,
    func_getdataloader_pred,
    func_getdataloader_pred_16,
)
...
def parse_args_():
    ...
    parser.add_argument(
        "--test_datapath",
        type=str,
        default="/data/ldap_shared/synology_shared/zyd/data/20220611_detparticle/testdataset/test_MICROTUBULE/SNR7/",
    )
...
if __name__ == "__main__":
    ...
    # load data model
    if datatype == "16bit":
        dataloader_ins_test = func_getdataloader_pred_16(
            model_mode,
            test_datapath,
            batch_size=1,
            shuffle=False,
        ...
        dataloader_ins_test = func_getdataloader_pred(
            model_mode,
            test_datapath,
            batch_size=1,
            shuffle=False,
    ...
    for data in dataloader_ins_test:
        ...
        # NMS
        if scores is None:
            scores = np.array([1.0] * len(pred_coords_pd))
        # thresh = 25
